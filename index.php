...
<head>
<title>KRISNA</title>
<link rel="shortcut icon" href="images2/krisna_icon.ico">
...
<div id="wrap">
  <div id="header">
    <!--<h1 id="logo-text">KRISNA</h1>
    <h2 id="slogan">APLIKASI ARSIP PASPOR INDONESIA</h2>-->
	<p><div align="left"><img src="images/krisna_logo.png" height="75"></div></p>
  </div>
  <div  id="menu">
    <marquee style="color:yellow">SELAMAT DATANG DI APLIKASI KRISNA, SILAKAN LOGIN TERLEBIH DAHULU</marquee>
  </div>
  <div id="content-wrap">
...
<?php 
      ...
      <form action='ceklogin.php' method='POST'>
        <div align='center'>
		<table>
			<tr><td>NIP</td><td><input type='text' name='nip' size='30' required><br></td></tr>
