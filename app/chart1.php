...
<script src="js/Chart.js"></script>
	...
	$sql="select a.tanggal_input,COUNT(*) as 'total' FROM arsip_paspor a LEFT JOIN rak b ON a.nomor_rak=b.nomor_rak
													   WHERE a.tanggal_input > '$tgl_awal' AND b.lokasi='$s[seksi]'
